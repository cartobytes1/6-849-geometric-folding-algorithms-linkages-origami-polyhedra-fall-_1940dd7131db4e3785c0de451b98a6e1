...
menu:
  leftnav:
    identifier: 09ded0d2dbc8da15f5d3605f216c0866
    name: Final Project
    weight: 120
title: Final Project
type: course
uid: 09ded0d2dbc8da15f5d3605f216c0866

---

Other than the [Assignments]({{< baseurl >}}/sections/assignments), the main requirement for this course is the project. The project consists of at least two components:
...
A number of [sample project ideas]({{< baseurl >}}/sections/final-project/sample-project-ideas), based on the topics covered in the course, are provided.
